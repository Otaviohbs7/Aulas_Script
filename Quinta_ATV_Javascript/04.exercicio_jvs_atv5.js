...
while (check) {
    ...
    let nomes_cadastrar = ler.question("Informe o nome para adicionar a lista, ou 0 para sair: ").toLowerCase();
...
while (conf) {
    ...
    let procura = ler.question("Informe um nome ou 0 para sair: ").toLowerCase();
    if (procura == 0) {
        conf = false;
    } else {
            let fbi = 0;
