...
while (check) {
    ...
    console.log("qual função executar?");
    ...
    switch (escolha) {
        case 1:
            ...
            let anos = ler.questionInt("tempo de colaboração na empresa: ");
            funcionarios.push({nome: nome, departamento: departamento, cargo: cargo, anos: anos})
            let pergunta = ler.question("Para continuar digite uma tecla: ");
            break;
        case 2:
            ...
            if (adm == 1) {
                ...
                switch (escolhedit) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        let newano = ler.questionInt("Tempo na empresa: ");
